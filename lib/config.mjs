...
export function buildConfiguration({ root, agentDir, binDir, nodePath, platform = process.platform, home, repoDir, shellPath }) {
  ...
  for (const [name, profile] of Object.entries(profiles)) {
    ...
    const settings = {
      ...
      extensions: [join(targetAssets, "extensions", "rose-pine-palette.ts"), join(targetAssets, "extensions", "pi-rewind")],
    ...
    addJson(join(dir, "keybindings.json"), { "app.clipboard.pasteImage": [] });
