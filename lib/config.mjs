...
export function buildConfiguration({ root, agentDir, binDir, nodePath, platform = process.platform, home, repoDir, shellPath }) {
  ...
  for (const [name, profile] of Object.entries(profiles)) {
    ...
    // Codex/OpenAI hoặc web search của Claude (cầu nối native-web-search); model khác và lỗi tạm thời dùng Firecrawl.
    ...
    addJson(join(dir, "web-search.json"), {
      ...
      webSearch: { allowedProviders: ["openai", "firecrawl"] },
      searchRouting: {
        providers: ["openai", "firecrawl"], useCurrentModel: true,
