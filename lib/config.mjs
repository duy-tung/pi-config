...
export function buildConfiguration({ root, agentDir, binDir, nodePath, platform = process.platform, home, repoDir, shellPath }) {
  ...
  for (const [name, profile] of Object.entries(profiles)) {
    ...
    const settings = {
      ...
      modelThinkingLevels: { "openai-codex/gpt-5.6-sol": "high", "openai-codex/gpt-6-astra": "high" },
    ...
    if (name !== "advisor") settings.enabledModels = ["openai-codex/gpt-6-astra", "openai-codex/gpt-5.6-sol"];
    ...
    if (name !== "advisor") modelOverrides["gpt-6-astra"] = { contextWindow: 872000 };
