...
const definitions = {
  ...
  goal: {
    runtime: "compat", provider: "anthropic", model: "claude-opus-5", thinking: "medium",
...
export function buildConfiguration({ root, agentDir, binDir, nodePath, platform = process.platform, home, repoDir, shellPath }) {
  ...
  for (const [name, profile] of Object.entries(profiles)) {
    ...
    if (name === "main") settings.enabledModels = ["openai-codex/gpt-6-astra", "openai-codex/gpt-5.6-sol"];
    ...
    // Snapshot only; do not invent a model missing from Pi 0.84.4's catalog.
    if (name === "main") modelOverrides["gpt-6-astra"] = { contextWindow: 872000 };
    addJson(join(dir, "models.json"), { providers: { "openai-codex": { modelOverrides } } });
