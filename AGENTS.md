...
- Cấu hình chuẩn: parent Astra/high; researcher GLM/max; worker, debugger, reviewer Sol/high. Một runtime Pi 0.87.1, một cấu hình main; dùng Agent của @tintinweb/pi-subagents và slash command trong cùng phiên.
