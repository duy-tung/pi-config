...
Mặc định Astra parent/Sol worker với high cho các model đã chọn; goal/background cũng dùng Astra high qua định nghĩa model tương thích; advisor giữ cấu hình riêng.
