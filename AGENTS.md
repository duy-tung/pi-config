...
- Cấu hình chuẩn: parent Claude Opus 5.5/high; researcher GLM/max; worker, debugger GPT-6 Sol/max; reviewer, advisor, goal auditor và Oracle GPT-6 Astra/high; auto mode: Jev jev-1.13.0 sàng lọc (khi có key TypeSafe), GPT-6 Sol/low xét kỹ phần bị gắn cờ. Agent không giới hạn số lượt. Một runtime Pi 0.87.1, một cấu hình main; dùng Agent của @tintinweb/pi-subagents và slash command trong cùng phiên.
