...
Mặc định Astra parent/Sol worker với high cho các model đã chọn; goal/background cũng dùng Astra high qua định nghĩa model tương thích; advisor dùng Sol high executor và Astra high advisor; mọi model được gán đều thuộc openai-codex.
