...
Giao việc bằng Agent của @tintinweb/pi-subagents, không có dispatcher/router tự viết. Bốn role mặc định ghim Sol/high; researcher-glm, worker-glm, debugger-glm ghim GLM/max, giữ đúng tools và context riêng. Reviewer giữ Sol. Không thêm event gate hoặc classifier trả phí. Model trong role thắng tham số Agent; kiểm model/effort thực trong fixture trước khi phát hành.
