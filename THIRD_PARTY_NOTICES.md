...
`vendor/pi-advisor-flow-0.6.0-pi086.tgz` chứa package npm 0.6.0 với phạm vi peer metadata gồm `0.86.0`; các bản vá runtime được khai báo riêng trong `assets/patches.json`. SHA-256 của tarball: `6ac0352f3fc46b65a5961d2c2db54ca8e547b6fd6ee55c9ef966c85ee674b520`. Tarball chứa đầy đủ giấy phép MIT gốc. Profile compat dùng nguyên package npm 0.6.0.
